        ...
        <>
            ...
            >
                    ...
                    <div className="pt-1 w-100 mb-6 d-flex justify-content-between align-items-start">
                        <div>
                            <h5 className="mb-2 me-2 lh-sm">
                                <span className="fas fa-palette me-2 fs-8" />
                                Theme Customizer
                            </h5>
                ...
                <div className="offcanvas-body scrollbar px-card" id="themeController">
                    <div className="setting-panel-item mt-0">
                        ...
                        <div className="row gx-2">
                            <div className="col-4">
                                ...
                                />
                                <label
                                    className="btn d-inline-block btn-navbar-style fs-9"
                    ...
                    <div className="setting-panel-item">
                        ...
                        <div className="row gx-2">
                            <div className="col-6">
                                ...
                                <label
                                    className="btn d-inline-block btn-navbar-style fs-9"
                                    htmlFor="navbarPositionVertical"
                                >
                                    {" "}
                                    <span className="mb-2 rounded d-block">
                                        <img
                            ...
                            <div className="col-6">
                                ...
                                <label
                                    className="btn d-inline-block btn-navbar-style fs-9"
                                    htmlFor="navbarPositionHorizontal"
                                >
                                    {" "}
                                    <span className="mb-2 rounded d-block">
                                        <img
                            ...
                            <div className="col-6">
                                <input
                                    ...
                                    name="navigation-type"
                                    type="radio"
                                    defaultValue="dual-nav"
                                    data-theme-control="phoenixNavbarPosition"
                                />
                                <label
                                    className="btn d-inline-block btn-navbar-style fs-9"
                                    htmlFor="navbarPositionTopDouble"
                                >
                                    {" "}
                                    <span className="mb-2 rounded d-block">
                                        <img
                                    ...
                                    <span className="label-text"> Dual nav</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div className="setting-panel-item">
                        ...
                        <div className="row gx-2">
                            <div className="col-6">
                                ...
                                />
                                <label
                                    className="btn d-block w-100 btn-navbar-style fs-9"
                                    htmlFor="navbar-style-default"
                                >
                                    {" "}
                                    <img
                                        className="img-fluid img-prototype d-dark-none"
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                    <span className="label-text d-dark-none"> Default</span>
                                    <span className="label-text d-light-none">Default</span>
                                </label>
                            </div>
                            <div className="col-6">
                                <input
                                ...
                                >
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                    <span className="label-text d-dark-none"> Darker</span>
                                    <span className="label-text d-light-none">Lighter</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <a
                        className="bun btn-primary d-grid mb-3 text-white mt-5 btn btn-primary"
